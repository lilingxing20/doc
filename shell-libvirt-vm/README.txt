...
[root@lixx shell-libvirt-vm]# ./bin/upload_image.sh -i ./images/centos1810-template.qcow2 -n centos1810


## List image template
[root@lixx shell-libvirt-vm]# ./bin/list_image.sh 
 Name                                     Path                                                             Type    Capacity  Allocation
----------------------------------------------------------------------------------------------------------------------------------------
 T_IMG_centos1810                         /var/lib/libvirt/images/T_IMG_centos1810                         file   10.00 GiB    1.29 GiB


## List network
[root@lixx shell-libvirt-vm]# ./bin/list_network.sh
...
## Create a instance
[root@lixx shell-libvirt-vm]# ./bin/create_instance.sh -i test_vm1 -t T_IMG_centos1810 -n mgmt-net



########################################################################################
[root@lixx shell-libvirt-vm]# virsh help 
分组的命令：
